...
const Banner = ({netflixOriginals}:Props) => {
  ...
  return (
    <div  className="flex flex-col space-y-2 py-16 md:space-y-4 lg:h-[80vh] lg:justify-end lg:pb-12">
        ...
        <h1 className="text-2xl lg:text-7xl md:text-2xl font-bold ">{movie?.title|| movie?.original_title}</h1>
        <p className="max-w-xs  text-xs md:max-w-lg md:text-lg lg:max-w-2xl lg:text-xl ">{movie?.overview}</p>
